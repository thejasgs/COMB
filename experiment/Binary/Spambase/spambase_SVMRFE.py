...
data_set = 'spambase'  #@param {type: "string"}
root_path = '../../datasets/'
#cleaned data without non-attack values
X = pd.read_csv(root_path+data_set+'.csv', header=None, usecols=[i for i in range(57)])
Y = pd.read_csv(root_path+data_set+'.csv', header=None, usecols=[57])
...
# SVM RFE includes cross validation to choose the best number of features.
