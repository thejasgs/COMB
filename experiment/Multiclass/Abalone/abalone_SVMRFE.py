...
data_set = 'Abalone'  #@param {type: "string"}
root_path = '../../datasets/'
#cleaned data without non-attack values
X = pd.read_csv(root_path+'Abalone.csv', header=None, usecols=[i for i in range(1,9)])
Y = pd.read_csv(root_path+'Abalone.csv', header=None, usecols=[0])
