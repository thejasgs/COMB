...
data_set = 'iris'  #@param {type: "string"}
root_path = '../../datasets/'
#cleaned data without non-attack values
X = pd.read_csv(root_path+data_set+'.csv', header=None, usecols=[i for i in range(4)])
Y = pd.read_csv(root_path+data_set+'.csv', header=None, usecols=[4])
